...
assert.match(styles, /@media \(min-width: 841px\) \{[\s\S]*?\.selection-bar \{[\s\S]*?width: max-content;[\s\S]*?max-width: calc\(100vw - 32px - env\(safe-area-inset-left, 0px\) - env\(safe-area-inset-right, 0px\)\);[\s\S]*?flex-wrap: nowrap;/);
